...
const Home = () => {
    ...
    return (
        <div className='home'>
            ...
            <Container>
                <Row className="home-content justify-content-center">
                    <Col lg={6} md={12} className="home-intro">
                        <div className="display-4 home-greet mb-4"><span>👋</span></div>
                        <div className="display-3 home-name">I'm Ncuti Xavier</div>
                        <div className="h2 my-3">A software engineer</div>
